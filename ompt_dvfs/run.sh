...
export OMP_TOOL_LIBRARIES=${OMP_TOOL_LIBRARIES:-$PWD/ompt_dvfs/libompt_dvfs.so}
...
ompt_dvfs/render_ompt_timing "$TIMING_CSV" "$TIMING_SVG" "$STEP_INTERVAL"
